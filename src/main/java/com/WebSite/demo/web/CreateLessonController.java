...
public class CreateLessonController {
    ...
    public String createLesson(
            ...
            @RequestParam("answersCorrect[]") String[] answersCorrect,
            @RequestParam("answersWrong[]") String[] answersWrong)
    {
        lessonService.create(type, level, name, description, imageURL, task, informationSource, questions, answersCorrect, answersWrong);
        return "createLesson";
    }
